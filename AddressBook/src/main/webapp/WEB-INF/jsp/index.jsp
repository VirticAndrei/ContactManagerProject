						...
						<tbody>
							<c:forEach var="contact" items="${contacts}">
								<tr>
									...
									<td><a href="update-contact?idContact=${contact.getId()}"><span class="glyphicon glyphicon-pencil"></span></a></td>
									<td><a href="delete-contact?idContact=${contact.getId()}"><span class="glyphicon glyphicon-trash"></span></a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
		...
		<c:when test="${mode == 'MODE_NEW' || mode == 'MODE_UPDATE'}">
			<div class="container text-center">
				...
				<form class="form-horizontal" enctype="multipart/form-data" method="POST" action="save-contact">
					...
					<input type="hidden" name="idAddress" value="${contact.getAddress().getId()}"/>
					<input type="hidden" name="picture" value="${contact.getPictureBytes()}"/>
					<div class="form-group">
